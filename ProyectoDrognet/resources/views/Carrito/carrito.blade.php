        ...
        <div class="site-blocks-table">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
               <td class="product-thumbnail"><img src="{{ Storage::url($item->Imagen)}}" width="100px" height="100px"></td>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="row mb-5">
          ...
          <div class="col-md-6">
          <a href="{{route('productos.index')}}" class="btn btn-outline-primary btn-md btn-block">Continuar comprando</a>
          </div> <br> <br>
          <div class="col-md-6">
  ...
  <div class="site-section">
    <div class="container justify-content-center">
      <div class="row">
        ...
        <p><a href="{{route('productos.index')}}" class="btn btn-md height-auto px-4 py-3 btn-primary">Ir a la tienda</a></p>
        </div>
      </div>
    </div>
  </div>
