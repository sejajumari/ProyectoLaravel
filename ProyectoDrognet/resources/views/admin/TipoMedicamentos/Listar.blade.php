...
@section('content')
<div class="container">
  <a href="{{route('medicamentos.create')}}"><button  class="btn btn-primary">Crear</button></a>  
 <hr>
...
<tbody>
            @forelse ($medicamentos as $dato)
                <tr>
                <td>{{$dato->IdTipoMedicamento}}</td>
                <td>{{$dato->Nombre}}</td>
             

                <td>
                <a href="{{route('medicamentos.edit', $dato->IdTipoMedicamento)}}"><button class="btn btn-info">Editar</button></a>  
                 <a href="{{route('medicamentos.destroy', $dato->IdTipoMedicamento)}}" onclick="return confirm('¿esta seguro de eliminar el registro?')"><button class="btn btn-danger">Eliminar</button></a> 
            </td>
