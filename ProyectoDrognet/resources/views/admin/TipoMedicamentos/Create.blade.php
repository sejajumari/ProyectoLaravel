...
<div class="container justify-content-center">
    ...
    <form action="{{route('medicamentos.store')}}" method="POST" class="border p-3 form">
        @csrf
        <div class="form-group aligns-items-center">
            <div class="col-md-6">
            <label for="nombre">Nombre</label>
            <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Digite nombre del tipo de medicamento">
        </div>
        </div>
        <button class="btn btn-primary">Crear</button>
    </form>
    <hr>
    <a href="{{route('medicamentos.index')}}"><button  class="btn btn-primary">Listar</button></a> 
