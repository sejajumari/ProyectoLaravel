...
@section('content')
    <div class="container justify-content-center">
        <div class="col-md-6">
    <form action="{{route('medicamentos.update',$medicamentos->IdTipoMedicamento)}}" class="border p-3 form">
        @csrf
        <div class="form-group">
            <label for="nombre">Nombre</label>
            <input type="text" value="{{$medicamentos->Nombre}}" class="form-control" name="nombre" id="nombre" placeholder="Digite su nombre del departamento">
        </div>
