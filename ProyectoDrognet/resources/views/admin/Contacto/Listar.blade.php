...
@section('content')
<div class="container">
 <a href="{{route('quejas.create')}}"><button  class="btn btn-primary">Crear</button></a> 
 <hr>
...
<tbody>
            @forelse ($quejas as $dato)
                <tr>
                <td>{{$dato->IdQuejaSugerencia}}</td>
                <td>{{$dato->Tema}}</td>
                <td>{{$dato->Descripcion}}</td>
                <td>{{$dato->Fecha}}</td>
                <td>
                <a href="{{route('quejas.edit', $dato->IdQuejaSugerencia)}}"><button class="btn btn-info">Editar</button></a> 
                <a href="{{route('quejas.destroy', $dato->IdQuejaSugerencia)}}" onclick="return confirm('¿esta seguro de eliminar el registro?')"><button class="btn btn-danger">Eliminar</button></a> 
            </td>
