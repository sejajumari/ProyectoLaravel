...
<div class="container">
    <form action="{{route('quejas.update',$quejas->IdQuejaSugerencia)}}" class="border p-3 form">
        @csrf
            ...
            <div class="form-group row">
              ...
              <input type="text" class="form-control" value="{{$quejas->Tema}}"  name="Tema">
              </div>
            </div>
              
            <div class="form-group row">
                <div class="col-md-12">
                  <label  class="text-black">Descripcion</label>
                  <input type="text" class="form-control" value="{{$quejas->Descripcion}}"  name="Descripcion">
                </div>
              </div>
              
            <div class="form-group row">
                <div class="col-md-12">
                  <label  class="text-black">Fecha<span class="text-danger">*</span></label>
                  <input type="date" class="form-control" value="{{$quejas->Fecha}}"  name="Fecha" placeholder="">
                </div>
              </div>
            <div class="form-group row">
              <div class="col-lg-12">
          ...
          <hr>
          <input type="submit" class="btn btn-outline-primary" href="{{route('quejas.index')}}" value="regresar">
    </form>
</div>
