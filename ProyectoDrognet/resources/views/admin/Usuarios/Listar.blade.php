...
@section('content')
<div class="container">
 {{-- <a href="{{route('usuarios.create')}}"><button  class="btn btn-primary">Crear</button></a>  --}}
 <hr>
...
<tbody>
            @forelse ($usuarios as $dato)
                ...
                <td>
                <a href="{{route('usuarios.editar',$dato->id)}}" class="btn btn-primary">Editar</a> <br><br>
                <a href="{{route('usuarios.eliminar', $dato->id)}}" onclick="return confirm('¿esta seguro de eliminar el registro?')"><button class="btn btn-danger">Eliminar</button></a> 
