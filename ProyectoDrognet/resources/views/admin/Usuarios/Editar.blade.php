...
@section('content')
        ...
        <div class="container">
    <form action="{{route('usuarios.update',$usuarios->id)}}" class="border p-3 form" >
        @csrf
        ...
        <select name="rol" id="" class="form-control">
          <option value="{{$usuarios->rol}}" selected>{{$usuarios->rol}}</option>
           <option value="{{$usuarios->rol}}">{{$usuarios->rol[0]}}</option>
           <option value="{{$usuarios->rol}}">{{$usuarios->rol[1]}}</option>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="email" id="nombre" value="{{$usuarios->email}}">
        </div>
        <div class="col-md-6">
            <label for="nombre">Contraseña</label>
            <input type="text" class="form-control" name="password" id="nombre" value="{{$usuarios->password}}" >
        </div>
