  ...
  <div class="container" id="lista-productos">
      <div class="row">
          <div class="col-md-5 mr-auto">
              ...
              <img class="card-img-top" src="{{ Storage::url($productos[0]->Imagen)}}" asp-append-version="true" width="300px" height="300px">
              </div>
          </div>
          <div class="col-md-6">
...
<center>
  <div>
  <p><a href="{{route('productos.index')}}" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Volver a la lista</a></p>
