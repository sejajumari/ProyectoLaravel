          ...
          <div class="row mb-5">
            <div class="col-md-12">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <a  href="{{route('payment.payment')}}" class="btn btn-outline-warning btn-md btn-block">Pagar con PayPal &nbsp; <i class="fa fa-paypal fa-2x"></i></a>
                          </div>
  
                <div class="form-group">
                  <button class="btn btn-primary btn-lg btn-block" onclick="window.location='thankyou.html'">Realizar su pedido</button>
                </div>
